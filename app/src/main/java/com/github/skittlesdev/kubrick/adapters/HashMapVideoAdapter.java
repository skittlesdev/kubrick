 ...
 */
public class HashMapVideoAdapter extends RecyclerView.Adapter<HashMapVideoAdapter.ViewHolder> {
    private ArrayList<HashMap<String, String>> videos;

    public HashMapVideoAdapter(ArrayList<HashMap<String, String>> videos) {
        super();
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void setItem(HashMap<String, String> item) {
            String videoName = item.get("name");
        ...
        public void onClick(View view) {
            ...
            Intent intent = new Intent(Intent.ACTION_VIEW,
                    Uri.parse("http://www.youtube.com/watch?v=" + this.video.get("key")));
